...
def build_transformer(
    ...
    shared_encoder_blocks = encoder_blocks
    shared_decoder_blocks = decoder_blocks

    encoder = Encoder(nn.ModuleList(shared_encoder_blocks))
    decoder = Decoder(nn.ModuleList(shared_decoder_blocks))
